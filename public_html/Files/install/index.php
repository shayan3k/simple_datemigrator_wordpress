  ...
  ////####################################################
  $extensions = [
      'openssl' ,'pdo', 'mbstring', 'tokenizer', 'JSON', 'cURL', 'XML', 'fileinfo', 'Ctype', 'BCMath', 'gmp'
  ];
  ...
  $my_url = urlencode($base_url);
  $api = "https://thesoftking.com/verify/api.php?code=$code&user=$user&domain=$my_url";
...
<center><a href="https://bit.ly/2QCCRlD" target="_blank">Free scriptzZz!</a></center>
